...
{path.pathname!=='/signup'&&<Text onClick={handleClick}  padding={"10px"} cursor={'pointer'} >LOGIN</Text>}
...
<Text  padding={"10px"} cursor={'pointer'}>SHOPPING BAG({})</Text>
 ...
 {path.pathname==="/cover"&&<Text onClick={handleMen}>MEN</Text>}
 {path.pathname==="/cover"&&<Text  onClick={handleWomen}>WOMEN</Text>}
 {path.pathname==="/cover"&&<Text  onClick={handleKids}>KIDS</Text>}
