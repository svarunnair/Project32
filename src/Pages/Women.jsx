...
<Flex position={'sticky'} zIndex="1000"  top="200" marginTop={"100px"} marginBottom={"-80px"} marginLeft={"30px"} gap={"10px"}>
        <Button fontWeight={450} width={{ base: "20px", md: "30px", lg: "50px" }} bg={"rgba(255,255,255,0)"} height={"25px"} border={"1px solid black"} borderRadius={"0px"}  fontSize={"small"} color={'black'}>SIZE</Button>
        <Button fontWeight={450} width={{ base: "20px", md: "30px", lg: "50px" }} bg={"rgba(255,255,255,0)"} height={"25px"} border={"1px solid black"} borderRadius={"0px"}  fontSize={"small"} color={'black'}>PRICE</Button>
        <Button fontWeight={450} width={{ base: "20px", md: "30px", lg: "70px" }} bg={"rgba(255,255,255,0)"} height={"25px"} border={"1px solid black"} borderRadius={"0px"}  fontSize={"small"} color={'black'}>COLOUR</Button>
