      ...
      <>
        ...
        zIndex="1000" >
          ...
          <Flex  h={16} alignItems={'center'} justifyContent={'space-between'}>
            ...
            <Flex onClick={handleMeanu} cursor={"pointer"}><Text marginLeft={"20px"} fontSize={"xx-large"} color={"black"}>=</Text></Flex>
          <Box   marginLeft={"15px"} marginTop={"115px"}>
            ...
            viewBox="0 0 132 55" xmlns="http://www.w3.org/2000/svg">
             ...
             {show&&<Box marginLeft={"-30px"} marginTop={70} border={"2px solid red"} position={"sticky"} width={300} height={300} bg={'yellow'} color={'black'}>
